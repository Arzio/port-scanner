...
def help_message() -> None:
    ...
    """
    print(
        'Um analisador de portas TCP e UDP\n\n'
        'Uso: portscanner.py [opções]\n\n'
        'Opções:\n'
        '\t--help: Exibe essa mensagem\n'
        '\t--ip: Representa o IP do host a ser analisado. É um argumento obrigatório.\n'
        '\t--ports: As portas a serem scanneadas. Devem ser separadas por vírgula. É um argumento obrigatório. Ex: "21,22,80,8080"\n'
        '\t--tcp e --udp: Informam o tipo de portas a serem analisadas. No mínimo uma deve ser declarada.\n'
...
class ArgsParser:
    ...
    def has_valid_args(self) -> bool:
        ...
        """
        return self.ports and self.ip != '' and (self.tcp or self.udp)
